...
module.exports = {
  ...
  repo: 'https://github.com/Blackcat308', // 导航栏右侧生成Github链接
  ...
  author: {
    ...
    name: 'LaoCat', // 必需
    link: 'https://github.com/Blackcat308', // 可选的
  },
  social: {
    // 社交图标，显示于博主信息栏和页脚栏
  ...
  footer: {
    ...
    copyrightInfo:
      'Eryajf | <a href="https://github.com/LaoCat/blob/main/LICENSE" target="_blank">MIT License</a>', // 博客版权信息，支持a标签
  }
}